...
class QuestionerPlacementController extends Controller
{
    /**
    ...
    $datas = 'App\Services\Helper'::getRequest('ApiQuestionerPlacementServiceClass/' . $idCon);
    $datas = json_decode($datas, true);
    $datas = json_decode($datas, true);
    //echo '<pre>'; print_r($datas); die;
    return view('others/QuestionerPlacementService')->with(compact('datas'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $response='App\Services\Helper'::postRequest($finalReq, 'ApiQuestionerPlacementServiceClass');
        if($response=='"OK"'){
