    ...
    <div class="gaccca-col gaccca-large-size_1-of-1 gaccca-medium-size_1-of-1">
      ...
      <div class="gaccca-col gaccca-large-size_1-of-1 gaccca-medium-size_1-of-1">
        ...
        <div class="gaccca-form-element gaccca-form-element-margin">
          <label class="gaccca-form-element__label" for="text-input-id-fn">
            ...
            <p><img src="assets/images/PDFImage.png" width="18" height="18" /><a href="#">Proof of Student Status</a>
            </p>
            <p><img src="assets/images/PDFImage.png" width="18" height="18" /><a href="#">Proof of Student
                Graduation</a></p>
          </label>
      ...
      <div class="gaccca-col gaccca-large-size_1-of-1 gaccca-medium-size_1-of-1">
        ...
        <div class="gaccca-form-element gaccca-form-element-margin">
          ...
          <div class="gaccca-form-element__control">
            <input type="text" id="text-input-id-c" placeholder="Citizenship " required="" class="gaccca-input" />
        ...
        <div class="gaccca-form-element gaccca-form-element-margin">
          ...
          <div class="gaccca-form-element__control">
            <input type="text" id="text-input-id-colpr" placeholder="Country of Legal Permanent Residency" required=""
              class="gaccca-input" />
        ...
        <div class="gaccca-form-element gaccca-form-element-margin">
          ...
          <div class="gaccca-form-element__control">
            <input type="text" id="text-input-id-us-visa" placeholder="Have you ever applied for a US visa" required=""
              class="gaccca-input" />
        ...
        <div class="gaccca-form-element gaccca-form-element-margin">
          ...
          <div class="gaccca-form-element__control">
            <input type="text" id="text-input-id-cob" placeholder="City of Birth" required="" class="gaccca-input" />
        ...
        <div class="gaccca-form-element gaccca-form-element-margin">
          ...
          <div class="gaccca-form-element__control">
            <input type="text" id="text-input-id-ecp" placeholder="Emergency Contact Person outside the US" required=""
              class="gaccca-input" />
        ...
        <div class="gaccca-form-element gaccca-form-element-margin">
          ...
          <div class="gaccca-form-element__control">
            <input type="text" id="text-input-id-ecp" required="" class="gaccca-input" />
        ...
        <div class="gaccca-form-element gaccca-form-element-margin">
          ...
          <div class="gaccca-form-element__control">
            <input type="text" id="text-input-id-e-email" placeholder="Emergency Contact Person Email Address"
        ...
        <div class="gaccca-form-element gaccca-form-element-margin">
          ...
          <div class="gaccca-form-element__control">
            <input type="text" id="text-input-id-e-phone" placeholder="Emergency Contact Person Phone Number"
              required="" class="gaccca-input" />
        ...
        <div class="gaccca-form-element gaccca-form-element-margin">
          ...
          <div class="gaccca-form-element__control">
            <input type="text" id="text-input-id-nou" placeholder="Name of University " required=""
              class="gaccca-input" />
          </div>
        </div>
        ...
        <div class="gaccca-form-element gaccca-form-element-margin">
          ...
          <div class="gaccca-form-element__control">
            <input type="text" id="text-input-id-fos" placeholder="Field of Study" required="" class="gaccca-input" />
          </div>
        </div>
        ...
        <div class="gaccca-form-element gaccca-form-element-margin">
          ...
          <div class="gaccca-form-element__control">
            <input type="text" id="text-input-id-egd" required="" class="gaccca-input-date" />
          </div>
        </div>
        ...
        <div class="gaccca-form-element gaccca-form-element-margin">
            ...
            <div class="gaccca-form-element__control">
              <input type="text" id="text-input-id-foi" required="" class="gaccca-input" />
          ...
          <div class="gaccca-form-element gaccca-form-element-margin">
            ...
            <div class="gaccca-form-element__control">
              <input type="text" id="text-input-id-ssdoi" required="" class="gaccca-input-date" />
            </div>
          </div>
          ...
          <div class="gaccca-form-element gaccca-form-element-margin">
            ...
            <div class="gaccca-form-element__control">
              <input type="text" id="text-input-id-sedoi" required="" class="gaccca-input-date" />
            </div>
          </div>
          <br/>
          ...
          <div class="gaccca-form-element gaccca-form-element-margin">
            ...
            <div class="gaccca-form-element__control">
              <input type="text" id="text-input-id-hcn" required="" class="gaccca-input" />
            </div>
          </div>
          ...
          <div class="gaccca-form-element gaccca-form-element-margin">
            ...
            <div class="gaccca-form-element__control">
              <input type="text" id="text-input-id-hcw" required="" class="gaccca-input" />
            </div>
          </div>
          ...
          <div class="gaccca-form-element gaccca-form-element-margin">
            ...
            <div class="gaccca-form-element__control">
              <input type="text" id="text-input-id-hca" required="" class="gaccca-input" />
            </div>
          </div>
          ...
          <div class="gaccca-form-element gaccca-form-element-margin">
            ...
            <div class="gaccca-form-element__control">
              <input type="text" id="text-input-id-city" required="" class="gaccca-input" />
            </div>
          </div>
          ...
          <div class="gaccca-form-element gaccca-form-element-margin">
            ...
            <div class="gaccca-form-element__control">
              <input type="text" id="text-input-id-zipcode" required="" class="gaccca-input" />
            </div>
          </div>
          ...
          <div class="gaccca-form-element gaccca-form-element-margin">
            ...
            <div class="gaccca-form-element__control">
              <input type="text" id="text-input-id-hccp" required="" class="gaccca-input" />
          ...
          <div class="gaccca-form-element gaccca-form-element-margin">
            ...
            <div class="gaccca-form-element__control">
              <input type="text" id="text-input-id-ccea" required="" class="gaccca-input" />
            </div>
          </div>
          ...
          <div class="gaccca-form-element gaccca-form-element-margin">
            ...
            <div class="gaccca-form-element__control">
              <input type="text" id="text-input-id-ccp" required="" class="gaccca-input" />
          ...
          <div class="gaccca-form-element gaccca-form-element-margin">
            ...
            <div class="gaccca-form-element__control">
              <input type="text" id="text-input-id-hpw" required="" class="gaccca-input" />
            </div>
          </div>
          ...
          <div class="gaccca-form-element gaccca-form-element-margin">
            ...
            <div class="gaccca-form-element__control">
              <input type="text" id="text-input-id-howmuch" required="" class="gaccca-input" />
            <br/>
          ...
          <div class="gaccca-form-element gaccca-form-element-margin">
            ...
            <div class="gaccca-form-element__control">
              <input type="text" id="text-input-id-vohiupm" required="" class="gaccca-input" />
          ...
          <div class="gaccca-form-element gaccca-form-element-margin">
            ...
            <div class="gaccca-form-element__control">
              <input type="text" id="text-input-id-votiupm" required="" class="gaccca-input" />
          ...
          <div class="gaccca-form-element gaccca-form-element-margin">
            ...
            <div class="gaccca-form-element__control">
              <input type="text" id="text-input-id-tfeiu" required="" class="gaccca-input" />
