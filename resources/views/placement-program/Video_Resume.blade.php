		...
		<div class="gaccca-form-element gaccca-form-element-margin">
			<div style="border-style: solid;border-width: 1px;border-color: #6ca9f2;margin-top: -16px ;width: 485px !important;height: 450px !important;display:block" id='vdoBorder'>
				<table>
					<tr>
						<td>
							<image src="{{ asset('images/logo/gacca_logo.gif') }}" id="logoImage" style="position: relative;top: 110px;left: 136px;z-index: 100;" />
						</td>
					</tr>
					<tr>
						<td>
			...
			jQuery(function() {
			                                                              ...
			                                                              function startTeleprompter() {
			                                                                  ...
			                                                                  function decreaseHeight() {
			                                                                      ...
			                                                                      jQuery("#TeleprompterContent").css({'top': (position['top'] - (jQuery('#sliderSpeed').data('speed'))) + 'px'});
