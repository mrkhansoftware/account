...
<style>
                    ...
                    <div id="main" class="sidebar-none sidebar-divider-off">
                        ...
                        function cvData() {
                            ...
                            $(document).ready(function() {
                                var cvResumeJSON={"applicantName":null,"personalNoteTitle":null,"personalNoteDesc":null, "firstHalfData":[],"secondHalfData":[],"skill":null,"otherInfo":[]};                   
                                /*-----CV Content-------*/
                                cvResumeJSON.applicantName=   $( ".headline .row1" ).html();
                                //------------------ First Half CV DATA-------------
                                $(".column tr").each(function () {
                                    var firstHalfRow={"titleHeadData":null,"titleDescriptionData":null};
                                    var this_row = $(this);
                                ...
                                $(".bottomContainer .part").each(function () {
                                    var secondHalfRow={"boxHeaderName":null,"boxRowData":[]};
                                    var this_row = $(this);
                                    secondHalfRow.boxHeaderName = $.trim(this_row.find('h3 .eline').html());
                                    this_row.find('tr').each(function (i, el) {
                                        var secondHalfRowColumns={"rowFirstColumn":null,"rowSeconfColumn":null,"rowThirdColumn":null};
                                ...
                                var skillInformation={"skillTitle":null, "skillList":[]};
                                skillInformation.skillTitle=$( ".skillHeader" ).html(); 
                                var ii=1;
                                $(".skillName").each(function () {
                                    var this_row = $(this);
                                    // alert(this_row.text().trim());
                                    var skillRange=parseInt($('#rangeCvSlider'+ii).asRange('val'));
                                    skillInformation.skillList.push({"skillName":this_row.html(),"skillScale":skillRange});
                                    ii++;
                                });
                                cvResumeJSON.skill=skillInformation;
                                cvResumeJSON.otherInfo.push({"title":$( ".otherInfo1" ).html(),"text":$( ".otherInfoDesc1" ).html()});
                                cvResumeJSON.otherInfo.push({"title":$( ".otherInfo2" ).html(),"text":$( ".otherInfoDesc2" ).html()});
                        ...
                        function  designSelected(val){
                            if('{!profileLocked}'=='true'){return;}
                            document.getElementById('apexPg:frmTemp:templateDesign').value= val; 
                            saveTemplateInfo();
                        }
                        </script>
                        <apex:inputHidden id="hiddenData" value="{!cvDatas}" />
                            <apex:inputHidden id="hiddenDataJSON" value="{!cvDataJSON}" />
                        <div>
                            <div style="font-size:11px;" styleClass="ckeditor">
                                <div id="content" style="padding-left: 40px;">
                                    ...
                                    <em style="font-size:12px;">The text will be saved automatically.</em>
                                    <div id="editor" class="page" style="position:relative;font-size:12px;">
                                        <div  id='cvData' style="position:relative;pointer-events: none">
                                            <apex:outputPanel rendered="{! cvDatas == ''}">
                                            ...
                                            <apex:outputText escape="false" rendered="{! cvDatas != ''}" value="{!cvDatas}">
                                                                    ...
                                                                    <tr>
                                                                        <td width='40%' >
                                                                            <div  class='skill1 skillName'>
                                                                                <apex:outputPanel rendered="{!skil1Name==null || skil1Name==''}" layout="none">
                                                                                    Skill 1 
                                                                                </apex:outputPanel>
                                                                                <apex:outputPanel rendered="{!skil1Name!=null && skil1Name!=''}" layout="none">
                                                                                    <apex:outputText escape="false" value=" {!skil1Name}"/>  
                                                                                </apex:outputPanel>
                                                                            </div>
                                                                        </td>
                                                                        <td>
                                                                    ...
                                                                    <tr>
                                                                        <td width='40%'  >
                                                                            <div  class='skill2 skillName'>
                                                                                <apex:outputPanel rendered="{!skil2Name==null || skil2Name==''}" layout="none">
                                                                                    Skill 2 
                                                                                </apex:outputPanel>
                                                                                <apex:outputPanel rendered="{!skil2Name!=null && skil2Name!=''}" layout="none">
                                                                                    <apex:outputText escape="false" value=" {!skil2Name}"/>  
                                                                                </apex:outputPanel>
                                                                            </div>
                                                                    ...
                                                                    <tr>
                                                                        <td width='40%'  >
                                                                            <div  class='skill3 skillName'>
                                                                                <apex:outputPanel rendered="{!skil3Name==null || skil3Name==''}" layout="none">
                                                                                    Skill 3 
                                                                                </apex:outputPanel>
                                                                                <apex:outputPanel rendered="{!skil3Name!=null && skil3Name!=''}" layout="none">
                                                                                    <apex:outputText escape="false" value=" {!skil3Name}"/>  
                                                                                </apex:outputPanel>
                                                                            </div>
                                                                        </td>
                                                                        <td>
                                                                    ...
                                                                    <tr>
                                                                        <td width='40%'  >
                                                                            <div  class='skill4 skillName'>
                                                                                ...
                                                                                <apex:outputPanel rendered="{!skil4Name==null || skil4Name==''}" layout="none">
                                                                                    Skill 4 
                                                                                </apex:outputPanel>
                                                                                <apex:outputPanel rendered="{!skil4Name!=null && skil4Name!=''}" layout="none">
                                                                                    <apex:outputText escape="false" value=" {!skil4Name}"/>  
                                                                                </apex:outputPanel>
                                                    ...
                                                    <td width='100%' style='vertical-align: text-top;'>
                                                        <section >
                                                            <div class='skillFont otherInfo1'  >
                                                                <apex:outputPanel rendered="{!otherInfo1==null || otherInfo1==''}" layout="none">
                                                                    LANGUAGE 
                                                                </apex:outputPanel>
                                                                <apex:outputPanel rendered="{!otherInfo1!=null && otherInfo1!=''}" layout="none">
                                                                    <apex:outputText escape="false" value=" {!otherInfo1}"/>  
                                                                </apex:outputPanel>
                                                            ...
                                                            <div  class='otherInfoDesc1 textHover'>
                                                                ...
                                                                <apex:outputPanel rendered="{!otherInfoDesc1==null || otherInfoDesc1==''}" layout="none">
                                                                    Please write a personal note with around 6-10 sentences for the company. This should be a proper text with paragraphs.Please write a personal note with around 6-10 sentences for the company.12 
                                                                </apex:outputPanel>
                                                                <apex:outputPanel rendered="{!otherInfoDesc1!=null && otherInfoDesc1!=''}" layout="none">
                                                                    <apex:outputText escape="false" value=" {!otherInfoDesc1}"/>  
                                                                </apex:outputPanel>
                                                                
                                                            </div>
                                                            <div class='skillFont otherInfo2' >
                                                                <apex:outputPanel rendered="{!otherInfo2==null || otherInfo2==''}" layout="none">
                                                                    Hobby &amp; Interest 
                                                                </apex:outputPanel>
                                                                <apex:outputPanel rendered="{!otherInfo2!=null && otherInfo2!=''}" layout="none">
                                                                    <apex:outputText escape="false" value=" {!otherInfo2}"/>  
                                                                </apex:outputPanel> 
                                                            </div>
                                                            <div  class='otherInfoDesc2 textHover'>
                                                                <apex:outputPanel rendered="{!otherInfoDesc2==null || otherInfoDesc2==''}" layout="none">
                                                                    Please write a personal note with around 6-10 sentences for the company. This should be a proper text with paragraphs.Please write a personal note with around 6-10 sentences for the company.12 
                                                                </apex:outputPanel>
                                                                <apex:outputPanel rendered="{!otherInfoDesc2!=null && otherInfoDesc2!=''}" layout="none">
                                                                    <apex:outputText escape="false" value=" {!otherInfoDesc2}"/>  
                                                                </apex:outputPanel>
                                                            </div>
                                                        </section>
                                                    </td>
                                ...
                                <em style="font-size:12px;padding-left:40px;">The text will be saved automatically.</em>
  ...
  <script>
        ...
        $(document).ready(function() {
            $('[id^=rangeCvSlider]').asRange({
                ...
                onChange:function(instance) {
                    if (isCVSavedFlag && pageNotLoading) {
                        myLastCallFlag = true;
                        isCVSavedFlag = false; // to stop recursive call
                        clearTimeout(myLastCall);
                        cvData();
            ...
            $('#rangeCvSlider1').asRange('set', '{!skil1scale}');
            $('#rangeCvSlider2').asRange('set', '{!skil2scale}');
            $('#rangeCvSlider3').asRange('set', '{!skil3scale}');
            $('#rangeCvSlider4').asRange('set', '{!skil4scale}');
            
            //alert('{!templateDesign}');
            if('{!templateDesign}'!='' && '{!templateDesign}'!='Old'){
                document.getElementById('newSectionTemplate').style.display='block';
                document.getElementById('{!templateDesign}').checked=true;
            }
        ...
        function deleteOperation(doc) {
            if('{!profileLocked}'=='true'){return};
            document.getElementById('apexPg:docForm').reset();
        ...
        function changeOperation(doc) {
            if('{!profileLocked}'=='true'){return};
            document.getElementById('apexPg:docForm').reset();
            document.getElementById('updateDocumentId').value = doc;
        ...
        function remaneItFunction(name, id) {
            ...
            document.getElementById('updateDocumentId').value = id;
            document.getElementById('updatedfileName').value = name.trim();
