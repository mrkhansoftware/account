...
<div class="gaccca-main-containt">
        ...
        <div class="gaccca-col gaccca-large-size_1-of-1 gaccca-medium-size_1-of-1">
                ...
                <div class="gaccca-form-element gaccca-form-element-margin">
                    ...
                    <div class="gaccca-form-element__control">
                        ...
                        <span class="gaccca-radio">
                          <input type="radio" id="radio-w01" value="I-94 refers to the training plan describing my tasks during the internship." name="QuestionEx1" checked="" />
                        ...
                        <span class="gaccca-radio">
                          <input type="radio" id="radio-w02" value="The I-94 card serves to prove the legal-visitor status (for example for your employer) and can be retrieved after 24 hours from your arrival in the U.S. from the Customs and Border Protection website (CBP)." name="QuestionEx1" />
                        ...
                        <span class="gaccca-radio">
                          <input type="radio" id="radio-w03" value="I-94  is the name for the form to apply for a social security number." name="QuestionEx1" />
            ...
            <div class="gaccca-col gaccca-large-size_1-of-1 gaccca-medium-size_1-of-1">
                <div class="gaccca-form-element gaccca-form-element-margin">
                    ...
                    <div class="gaccca-form-element__control">
                        ...
                        <span class="gaccca-radio">
                          <input type="radio" id="sradio-w04" value="I can apply for a Social Security Number before start of my training." name="QuestionEx2" checked="" />
                        ...
                        <span class="gaccca-radio">
                          <input type="radio" id="sradio-w05" value="I have to first conduct my check-in with the sponsor within one week after starting at my host company before applying for an SSN." name="QuestionEx2" />
                        ...
                        <span class="gaccca-radio">
                          <input type="radio" id="sradio-w06" value="J-1 visa applicants are not eligible to apply for an SSN." name="QuestionEx2" />
            ...
            <div class="gaccca-col gaccca-large-size_1-of-1 gaccca-medium-size_1-of-1">
                <div class="gaccca-form-element gaccca-form-element-margin">
                    ...
                    <div class="gaccca-form-element__control">
                        ...
                        <span class="gaccca-radio">
                          <input type="radio" id="sradio-w07" value="An absolute maximum of 60 days." name="QuestionEx3" checked="" />
                        ...
                        <span class="gaccca-radio">
                          <input type="radio" id="sradio-w08" value="An absolute maximum 30 days." name="QuestionEx3" />
                        ...
                        <span class="gaccca-radio">
                          <input type="radio" id="sradio-w09" value="One week." name="QuestionEx3" />
                        ...
                        <span class="gaccca-radio">
                            <input type="radio" id="sradio-w09a" value="It doesn't matter." name="QuestionEx3" />
            ...
            <div class="gaccca-col gaccca-large-size_1-of-1 gaccca-medium-size_1-of-1">
                <div class="gaccca-form-element gaccca-form-element-margin">
                    ...
                    <div class="gaccca-form-element__control">
                        ...
                        <span class="gaccca-radio">
                          <input type="radio" id="sradio-w10" value="No." name="QuestionEx4" checked="" />
                        ...
                        <span class="gaccca-radio">
                          <input type="radio" id="sradio-w11" value="Yes." name="QuestionEx4" />
                        ...
                        <span class="gaccca-radio">
                          <input type="radio" id="sradio-w12" value="Yes but only of the sponsor approves." name="QuestionEx4" />
            ...
            <div class="gaccca-col gaccca-large-size_1-of-1 gaccca-medium-size_1-of-1">
                <div class="gaccca-form-element gaccca-form-element-margin">
                    ...
                    <div class="gaccca-form-element__control">
                        ...
                        <span class="gaccca-radio">
                          <input type="radio" id="sradio-w13" value="Yes, very important." name="QuestionEx5" checked="" />
                        ...
                        <span class="gaccca-radio">
                          <input type="radio" id="sradio-w14" value="No if I get paid by my host company." name="QuestionEx5" />
                        ...
                        <span class="gaccca-radio">
                          <input type="radio" id="sradio-w15" value="Yes, but I only need to prove that I have sufficient funds for the first two months of internship." name="QuestionEx5" />
            ...
            After starting your training in your host company, if your supervisor changes will you need to inform your sponsor organization GACC California? <span class="gaccca-text-required" title="required">*</span></label>
                        <span class="gaccca-radio">
                          <input type="radio" id="sradio-w16" value="No." name="QuestionEx6" checked="" />
                        ...
                        <span class="gaccca-radio">
                          <input type="radio" id="sradio-w17" value="Yes." name="QuestionEx6" />
                        ...
                        <span class="gaccca-radio">
                          <input type="radio" id="sradio-w18" value="Yes, but only if the tasks in the training plan change as well." name="QuestionEx6" />
            ...
            <div class="gaccca-col gaccca-large-size_1-of-1 gaccca-medium-size_1-of-1">
                <div class="gaccca-form-element gaccca-form-element-margin">
                    ...
                    <div class="gaccca-form-element__control">
                        ...
                        <span class="gaccca-radio">
                          <input type="radio" id="sradio-w19" value="The purpose of the travel validation is to inform the sponsor (GACC California) of your future international travel plans." name="QuestionEx7" checked="" />
                        ...
                        <span class="gaccca-radio">
                          <input type="radio" id="sradio-w20" value="The purpose of the travel validation is to inform the sponsor (GACC California) of your future travel plans inside the U.S." name="QuestionEx7" />
                        ...
                        <span class="gaccca-radio">
                          <input type="radio" id="sradio-w21" value="The purpose of the travel validation is to inform the sponsor (GACC California) of a past trip, and to provide the sponsor with the date of re-entry into the U.S." name="QuestionEx7" />
            ...
            <div class="gaccca-col gaccca-large-size_1-of-1 gaccca-medium-size_1-of-1">
                <div class="gaccca-form-element gaccca-form-element-margin">
                    ...
                    <div class="gaccca-form-element__control">
                        ...
                        <span class="gaccca-radio">
                          <input type="radio" id="sradio-w22" value="It refers to a person subject to the two-year foreign residence who must have resided in their home country for two years prior to applying for a J-1 visa." name="QuestionEx8" checked="" />
                        ...
                        <span class="gaccca-radio">
                          <input type="radio" id="sradio-w23" value="Two-Year Foreign Residency Requirement applies to all J-1 visa applicants without exception." name="QuestionEx8" />
                        ...
                        <span class="gaccca-radio">
                          <input type="radio" id="sradio-w24" value="If you are subject to the two-year rule it will be marked as such on your DS-2019 Form as well as on the J-1 Visa inside your passport." name="QuestionEx8" />
            ...
            <div class="gaccca-col gaccca-large-size_1-of-1 gaccca-medium-size_1-of-1">
                <div class="gaccca-form-element gaccca-form-element-margin">
                    ...
                    <div class="gaccca-form-element__control">
                        ...
                        <span class="gaccca-radio">
                          <input type="radio" id="sradio-w25" value="Your Host Company." name="QuestionEx9" checked="" />
                        ...
                        <span class="gaccca-radio">
                          <input type="radio" id="sradio-w26" value="GACC California." name="QuestionEx9" />
                        ...
                        <span class="gaccca-radio">
                          <input type="radio" id="sradio-w27" value="The U.S. Embassy." name="QuestionEx9" />
                        ...
                        <span class="gaccca-radio">
                            <input type="radio" id="sradio-w28" value="Your agency or university in your home country." name="QuestionEx9" />
            ...
            <div class="gaccca-col gaccca-large-size_1-of-1 gaccca-medium-size_1-of-1">
                <div class="gaccca-form-element gaccca-form-element-margin">
                    ...
                    <div class="gaccca-form-element__control">
                        ...
                        <span class="gaccca-radio">
                          <input type="radio" id="sradio-w29" value="The primary goals of the Exchange Visitor Program are to allow participants the opportunity to engage broadly with Americans, share their culture, strengthen their English language abilities, and learn new skills or build skills that will help them" name="QuestionEx10" checked="" />
                        ...
                        <span class="gaccca-radio">
                          <input type="radio" id="sradio-w30" value="The primary objective of the program is for the foreign national to participate in a labor program, receive a wage and save up enough money to return to the home country to start her or his career" name="QuestionEx10" />
                        ...
                        <span class="gaccca-radio">
                          <input type="radio" id="sradio-w31" value="The primary objective of the program is for the foreign national to learn about American culture in order to investigate opportunities to permanently live in the U.S. and launch a successful career." name="QuestionEx10" />
            ...
            <div class="gaccca-col gaccca-large-size_1-of-1 gaccca-medium-size_1-of-1">
                <div class="gaccca-form-element gaccca-form-element-margin">
                    ...
                    <div class="gaccca-form-element__control">
                        ...
                        <span class="gaccca-radio">
                          <input type="radio" id="sradio-w32" value="Within 4 weeks of arrival in the U.S." name="QuestionEx11" checked="" />
                        ...
                        <span class="gaccca-radio">
                          <input type="radio" id="sradio-w33" value="Within one week of start of training." name="QuestionEx11" />
                        ...
                        <span class="gaccca-radio">
                          <input type="radio" id="sradio-w34" value="By the end of the third week after arrival in the U.S." name="QuestionEx11" />
            ...
            <div class="gaccca-col gaccca-large-size_1-of-1 gaccca-medium-size_1-of-1">
                <div class="gaccca-form-element gaccca-form-element-margin">
                    ...
                    <div class="gaccca-form-element__control">
                        ...
                        <span class="gaccca-radio">
                          <input type="radio" id="sradio-w35" value="An internship / training program" name="QuestionEx12" checked="" />
                        ...
                        <span class="gaccca-radio">
                          <input type="radio" id="sradio-w36" value="A sightseeing program?" name="QuestionEx12" />
                        ...
                        <span class="gaccca-radio">
                          <input type="radio" id="sradio-w37" value="A labor program?" name="QuestionEx12" />
            ...
            <div class="gaccca-col gaccca-large-size_1-of-1 gaccca-medium-size_1-of-1">
                <div class="gaccca-form-element gaccca-form-element-margin">
                    ...
                    <div class="gaccca-form-element__control">
                        ...
                        <span class="gaccca-radio">
                          <input type="radio" id="sradio-w38" value="No." name="QuestionEx13" checked="" />
                        ...
                        <span class="gaccca-radio">
                          <input type="radio" id="sradio-w39" value="Yes." name="QuestionEx13" />
                        ...
                        <span class="gaccca-radio">
                          <input type="radio" id="sradio-w40" value="Yes but only if the move is farther than 5 miles from the current address." name="QuestionEx13" />
            ...
            <div class="gaccca-col gaccca-large-size_1-of-1 gaccca-medium-size_1-of-1">
                <div class="gaccca-form-element gaccca-form-element-margin">
                    ...
                    <div class="gaccca-form-element__control">
                        ...
                        <span class="gaccca-radio">
                          <input type="radio" id="sradio-w41" value="GACC California is my main contact until the issuance of the the DS-2019 form but GACC California's role ends right there and then which is as soon as you have received your form DS-2019." name="QuestionEx14" checked="" />
                        ...
                        <span class="gaccca-radio">
                          <input type="radio" id="sradio-w42" value="All decisions about my visa status during the J‐1 program are made by GACC California, not by the Host Company." name="QuestionEx14" />
                        ...
                        <span class="gaccca-radio">
                          <input type="radio" id="sradio-w43" value="However, all decisions about my visa status during the internship or training are made by the Host Company only, not GACC California." name="QuestionEx14" />
            ...
            <div class="gaccca-col gaccca-large-size_1-of-1 gaccca-medium-size_1-of-1">
                <div class="gaccca-form-element gaccca-form-element-margin">
                    ...
                    <div class="gaccca-form-element__control">
                        ...
                        <span class="gaccca-radio">
                          <input type="radio" id="sradio-w44" value="The U.S. Department of State." name="QuestionEx15" checked="" />
                        ...
                        <span class="gaccca-radio">
                          <input type="radio" id="sradio-w45" value="The U.S. Department of Agriculture." name="QuestionEx15" />
                        ...
                        <span class="gaccca-radio">
                          <input type="radio" id="sradio-w46" value="The U.S. Department of Education." name="QuestionEx15" />
            ...
            <div class="gaccca-col gaccca-large-size_1-of-1 gaccca-medium-size_1-of-1">
                <div class="gaccca-form-element gaccca-form-element-margin">
                    ...
                    <div class="gaccca-form-element__control">
                        ...
                        <span class="gaccca-radio">
                          <input type="radio" id="sradio-w47" value="I should only contact my supervisor at my host company. There is no need to contact you, the sponsor." name="QuestionEx16" checked="" />
                        ...
                        <span class="gaccca-radio">
                          <input type="radio" id="sradio-w48" value="First, I should contact you, my sponsor organization. The emergency hotline is 1-888-936-2489. If my sponsor organization is unable to help and solve my problem, I can call the U.S. Department of State emergency hotline number which is 1-866-283-9090" name="QuestionEx16" />
                        ...
                        <span class="gaccca-radio">
                          <input type="radio" id="sradio-w49" value="I should contact the U.S. Department of State's emergency hotline only. There is no need to contact you, the sponsor organization." name="QuestionEx16" />
            ...
            <div class="gaccca-col gaccca-large-size_1-of-1 gaccca-medium-size_1-of-1">
                <div class="gaccca-form-element gaccca-form-element-margin">
                    ...
                    <div class="gaccca-form-element__control">
                        ...
                        <span class="gaccca-radio">
                          <input type="radio" id="sradio-w50" value="Pre-Departure Orientation Handbook by Sponsor & Sponsor Emergency Hotline." name="QuestionEx17" checked="" />
                        ...
                        <span class="gaccca-radio">
                          <input type="radio" id="sradio-w51" value="U.S. Department of State Emergency Hotline & the Wilberforce Pamphlet (Rights and Protections for Temporary Workers)." name="QuestionEx17" />
                        ...
                        <span class="gaccca-radio">
                          <input type="radio" id="sradio-w52" value="All of the above." name="QuestionEx17" />
