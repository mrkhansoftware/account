...
<script>
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                if (formData.methodType == 'slotSelectedMethod') {
                    ...
                    if (requestResponse.isReSchedule && requestResponse.registerEventInfo.ICS_file__c == undefined) {
    ...
    function showBookedSlots() {
        ...
        slotBooked = '<button class="gaccca-button-reshedule" id="rescheduleCallBtn">Reschedule your call</button>';
