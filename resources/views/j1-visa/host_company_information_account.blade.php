...
@include('common.header',['datas'=>$datas,'title' =>'Host Company Information','page'=>'host_company_information_account','parent_page'=>'J1 Program'])
...
<div class="gaccca-main-containt">
      ...
      <input type="hidden" name="applicant[id]"  value="{{isset($datas['Appli']['Id'])?$datas['Appli']['Id']:''}}" />
      <input type="hidden" name="applicant[Contact__c]"  value="{{isset($datas['contID'])?$datas['contID']:''}}" />
          ...
          <div class="gaccca-large-size_1-of-1 gaccca-medium-size_1-of-1 gaccca-small-size_1-of-1">
            ...
            <div class="gaccca-form-element gaccca-form-element-margin">
              ...
              <div class="gaccca-form-element gaccca-form-element-margin">
                ...
                <div class="gaccca-form-element__control">
                  <input type="text" name="applicant[Phone_Number__c]"  value="{{isset($datas['Appli']['Phone_Number__c'])?$datas['Appli']['Phone_Number__c']:''}}" id="text-input-id-ccp"  required="" class="gaccca-input gaccca-input-phone"  />
