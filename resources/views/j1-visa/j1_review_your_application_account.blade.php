...
{!! Form::radio('applicant[Do_you_have_dual_citizenship__c]', 'No',isset($datas['Appli']['Do_you_have_dual_citizenship__c'])?($datas['Appli']['Do_you_have_dual_citizenship__c']=='No'?true:false):false,array('id'=>'radio-citizenship-no','required' => 'required','disabled' => 'disabled')); !!}
...
{!! Form::radio('applicant[Do_you_have_dual_citizenship__c]', 'Yes',isset($datas['Appli']['Do_you_have_dual_citizenship__c'])?($datas['Appli']['Do_you_have_dual_citizenship__c']=='Yes'?true:false):false,array('id'=>'radio-citizenship-yes' ,'required' => 'required','disabled' => 'disabled')); !!}
    ...
    <label class="gaccca-radio__label" for="radio-citizenship-yes">
      ...
      <span class="gaccca-padding-right-25">Yes </span>
          ...
          <div class="gaccca-form-element__control">
            ...
            {!! Form::text('applicant[Citizenship__c]',isset($datas['Appli']['Citizenship__c'])?$datas['Appli']['Citizenship__c']:'',array('class'=>'gaccca-input','required' => 'required','disabled' => 'disabled')); !!}
        ...
        <div class="gaccca-form-element gaccca-form-element-margin">
          ...
          <div class="gaccca-form-element__control">
            ...
            {!! Form::text('applicant[Country_of_Legal_Permanent_Residency__c]',isset($datas['Appli']['Country_of_Legal_Permanent_Residency__c'])?$datas['Appli']['Country_of_Legal_Permanent_Residency__c']:'',array('class'=>'gaccca-input','required' => 'required','disabled' => 'disabled')); !!}
        ...
        <div class="gaccca-form-element gaccca-form-element-margin">
          ...
          <div class="gaccca-form-element__control">
              ...
              {!! Form::text('applicant[haveYouEverAppliedForUSVisa__c]',isset($datas['Appli']['haveYouEverAppliedForUSVisa__c'])?$datas['Appli']['haveYouEverAppliedForUSVisa__c']:'',array('class'=>'gaccca-input','required' => 'required','disabled' => 'disabled')); !!}
        ...
        <div class="gaccca-form-element gaccca-form-element-margin">
          ...
          <div class="gaccca-form-element__control">
            ...
            {!! Form::text('applicant[Country_of_Birth__c]',isset($datas['Appli']['Country_of_Birth__c'])?$datas['Appli']['Country_of_Birth__c']:'',array('class'=>'gaccca-input','required' => 'required','disabled' => 'disabled')); !!}
        ...
        <div class="gaccca-form-element gaccca-form-element-margin">
          ...
          <div class="gaccca-form-element__control">
            ...
            {!! Form::text('applicant[City_of_birth__c]',isset($datas['Appli']['City_of_birth__c'])?$datas['Appli']['City_of_birth__c']:'',array('class'=>'gaccca-input','required' => 'required','disabled' => 'disabled')); !!}
        ...
        <div class="gaccca-form-element gaccca-form-element-margin">
          ...
          <div class="gaccca-form-element__control">
            <div class="gaccca-select_container">
              ...
              {!! Form::text('applicant[Maritial_Status__c]',isset($datas['Appli']['Maritial_Status__c'])?$datas['Appli']['Maritial_Status__c']:'',array('class'=>'gaccca-input','required' => 'required','disabled' => 'disabled')); !!}
        ...
        <div class="gaccca-form-element gaccca-form-element-margin">
          ...
          <div class="gaccca-form-element__control">
            ...
            {!! Form::text('applicant[Emergency_Contact_Person_outside_the_US__c]',isset($datas['Appli']['Emergency_Contact_Person_outside_the_US__c'])?$datas['Appli']['Emergency_Contact_Person_outside_the_US__c']:'',array('class'=>'gaccca-input','required' => 'required','disabled' => 'disabled')); !!}
        ...
        <div class="gaccca-form-element gaccca-form-element-margin">
          ...
          <div class="gaccca-form-element__control">
            {!! Form::text('applicant[Relationship_to_Applicant__c]',isset($datas['Appli']['Relationship_to_Applicant__c'])?$datas['Appli']['Relationship_to_Applicant__c']:'',array('class'=>'gaccca-input','required' => 'required','disabled' => 'disabled')); !!}
        ...
        <div class="gaccca-form-element gaccca-form-element-margin">
          ...
          <div class="gaccca-form-element__control">
              ...
              {!! Form::text('applicant[Emergency_Contact_Person_Email_Address__c]',isset($datas['Appli']['Emergency_Contact_Person_Email_Address__c'])?$datas['Appli']['Emergency_Contact_Person_Email_Address__c']:'',array('class'=>'gaccca-input','required' => 'required','disabled' => 'disabled')); !!}
        ...
        <div class="gaccca-form-element gaccca-form-element-margin">
          ...
          <div class="gaccca-form-element__control">
              ...
              {!! Form::text('applicant[Emergency_Contact_Person_PhoneNumber__c]',isset($datas['Appli']['Emergency_Contact_Person_PhoneNumber__c'])?$datas['Appli']['Emergency_Contact_Person_PhoneNumber__c']:'',array('class'=>'gaccca-input','required' => 'required','disabled' => 'disabled')); !!}
        ...
        <div class="gaccca-form-element gaccca-form-element-margin">
          ...
          <div class="gaccca-form-element__control">
            {!! Form::textarea('applicant[Emergency_Contact_Person_Address__c]',isset($datas['Appli']['Emergency_Contact_Person_Address__c'])?$datas['Appli']['Emergency_Contact_Person_Address__c']:'',array('class'=>'gaccca-textarea','required' => 'required','disabled' => 'disabled')); !!}
        ...
        <div class="gaccca-form-element gaccca-form-element-margin">
          ...
          <div class="gaccca-form-element__control">
              ...
              {!! Form::text('applicant[Name_of_University__c]',isset($datas['Appli']['Name_of_University__c'])?$datas['Appli']['Name_of_University__c']:'',array('class'=>'gaccca-input','required' => 'required','disabled' => 'disabled')); !!}
        ...
        <div class="gaccca-form-element gaccca-form-element-margin">
          ...
          <div class="gaccca-form-element__control">
            ...
            {!! Form::text('applicant[Field_of_Study__c]',isset($datas['Appli']['Field_of_Study__c'])?$datas['Appli']['Field_of_Study__c']:'',array('class'=>'gaccca-input','required' => 'required','disabled' => 'disabled')); !!}
        ...
        <div class="gaccca-form-element gaccca-form-element-margin">
          ...
          <div class="gaccca-form-element__control">
            <div class="gaccca-select_container">
              {!! Form::text('applicant[Type_of_Degree__c]',isset($datas['Appli']['Type_of_Degree__c'])?$datas['Appli']['Type_of_Degree__c']:'',array('class'=>'gaccca-input','required' => 'required','disabled' => 'disabled')); !!}
        ...
        <div class="gaccca-form-element gaccca-form-element-margin">
          ...
          <div class="gaccca-form-element__control">
            {!! Form::text('graduationDate',isset($datas['graduationDate'])?$datas['graduationDate']:'',array('class'=>'gaccca-input-date','required' => 'required','disabled' => 'disabled')); !!}
        ...
        <div class="gaccca-form-element gaccca-form-element-margin">
          ...
          <div class="gaccca-form-element__control">
            <div class="gaccca-select_container">
            {!! Form::text('applicant[Work_Experience_in_your_Field_of_Study_a__c]',isset($datas['Appli']['Work_Experience_in_your_Field_of_Study_a__c'])?$datas['Appli']['Work_Experience_in_your_Field_of_Study_a__c']:'',array('class'=>'gaccca-input','required' => 'required','disabled' => 'disabled')); !!}
              ...
              <div class="gaccca-form-element__control">
                <input type="text" name="applicant[Field_of_Internship__c]"  value="{{isset($datas['Appli']['Field_of_Internship__c'])?$datas['Appli']['Field_of_Internship__c']:''}}" id="text-input-id-foi" placeholder="Field of Internship " required="" disabled="disabled"  class="gaccca-input" />
            ...
            <div class="gaccca-form-element gaccca-form-element-margin">
              ...
              <div class="gaccca-form-element__control">
                <input type="text" name="scheduled_Start"  disabled="disabled" value="{{isset($datas['scheduled_Start'])?$datas['scheduled_Start']:''}}" id="text-input-id-colpr" placeholder="" class="gaccca-input-date" />
            ...
            <div class="gaccca-form-element gaccca-form-element-margin">
              ...
              <div class="gaccca-form-element__control">
                <input type="text" name="scheduled_End" disabled="disabled"  value="{{isset($datas['scheduled_End'])?$datas['scheduled_End']:''}}" id="text-input-id-us-visa" placeholder=""  class="gaccca-input-date" />
            ...
            <div class="gaccca-form-element gaccca-form-element-margin">
                ...
                <div class="gaccca-form-element__control">
                  <input type="text" name="applicant[Host_Company__c]"  value="{{isset($datas['Appli']['Host_Company__c'])?$datas['Appli']['Host_Company__c']:''}}" id="text-input-id-hcn" placeholder="Host Company Name" required="" disabled="disabled"  class="gaccca-input" />
              ...
              <div class="gaccca-form-element gaccca-form-element-margin">
                ...
                <div class="gaccca-form-element__control">
                  <input type="text" name="applicant[Host_Company_Website__c]"  value="{{isset($datas['Appli']['Host_Company_Website__c'])?$datas['Appli']['Host_Company_Website__c']:''}}" id="text-input-id-hcn" placeholder="Host Company Website" required="" disabled="disabled"  class="gaccca-input" />
              ...
              <div class="gaccca-form-element gaccca-form-element-margin">
                ...
                <div class="gaccca-form-element__control">
                  <textarea name="applicant['Address__c]"   placeholder="Host Company Address" required="" disabled="disabled"  class="gaccca-textarea">{{isset($datas['Appli']['Address__c'])?$datas['Appli']['Address__c']:''}}</textarea>
              ...
              <div class="gaccca-form-element gaccca-form-element-margin">
                ...
                <div class="gaccca-form-element__control">
                  <input type="text" name="applicant[City__c]"  value="{{isset($datas['Appli']['City__c'])?$datas['Appli']['City__c']:''}}" id="text-input-id-city" placeholder="City" required="" disabled="disabled"  class="gaccca-input" />
              ...
              <div class="gaccca-form-element gaccca-form-element-margin">
                ...
                <div class="gaccca-form-element__control">
                  <input type="text" name="applicant[ZIP_Code__c]"  value="{{isset($datas['Appli']['ZIP_Code__c'])?$datas['Appli']['ZIP_Code__c']:''}}" id="text-input-id-zipcode" placeholder="City" required="" disabled="disabled"  class="gaccca-input" />
            ...
            <div class="gaccca-form-element gaccca-form-element-margin">
                ...
                <div class="gaccca-form-element__control">
                  <div class="gaccca-select_container">
                    ...
                    <input type="text" name="applicant[State__c]"  value="{{isset($datas['Appli']['State__c'])?$datas['Appli']['State__c']:''}}" id="text-input-id-hccp" placeholder="Host Company Contact Person" required="" disabled="disabled"  class="gaccca-input" />
              ...
              <div class="gaccca-form-element gaccca-form-element-margin">
                ...
                <div class="gaccca-form-element__control">
                    <input type="text" name="applicant[Contact_Person__c]"  value="{{isset($datas['Appli']['Contact_Person__c'])?$datas['Appli']['Contact_Person__c']:''}}" id="text-input-id-hccp" placeholder="Host Company Contact Person" required="" disabled="disabled"  class="gaccca-input" />
              ...
              <div class="gaccca-form-element gaccca-form-element-margin">
                ...
                <div class="gaccca-form-element__control">
                  <input type="email" name="applicant[Do_you_have_dual_citizenship__c]"  value="{{isset($datas['Appli']['Email_Address__c'])?$datas['Appli']['Email_Address__c']:''}}" id="text-input-id-ccea" placeholder="Company Contact email address " required="" disabled="disabled"  class="gaccca-input" />
              ...
              <div class="gaccca-form-element gaccca-form-element-margin">
                ...
                <div class="gaccca-form-element__control">
                  <input type="text" name="applicant[Phone_Number__c]"  value="{{isset($datas['Appli']['Phone_Number__c'])?$datas['Appli']['Phone_Number__c']:''}}" id="text-input-id-ccp" placeholder="Company Contact phone" required="" disabled="disabled"  class="gaccca-input" />
              ...
              <div class="gaccca-form-element gaccca-form-element-margin">
                ...
                <div class="gaccca-form-element__control">
                  <input type="text" name="applicant[Hours_Per_Week__c]"  value="{{isset($datas['Appli']['Hours_Per_Week__c'])?$datas['Appli']['Hours_Per_Week__c']:''}}" id="text-input-id-hpw" placeholder="Hours per week" required="" disabled="disabled"  class="gaccca-input" />
              ...
              <div class="gaccca-form-element gaccca-form-element-margin">
                ...
                <div class="gaccca-form-element__control">
                    ...
                    <span class="gaccca-radio">
                    {!! Form::radio('stipend', 'No',isset($datas['stipend'])?($datas['stipend']=='No'?true:false):false,array('id'=>'radio-no','required' => 'required','disabled' => 'disabled')); !!}
     
                      <label class="gaccca-radio__label" for="radio-no">
                        <span class="gaccca-radio_faux"></span>
                        <span class="gaccca-padding-right-25">No</span>
                      </label>
                      {!! Form::radio('stipend', 'Yes',isset($datas['stipend'])?($datas['stipend']=='Yes'?true:false):false,array('id'=>'radio-yes','required' => 'required','disabled' => 'disabled')); !!}
              ...
              <div class="gaccca-form-element gaccca-form-element-margin">
                ...
                <div class="gaccca-form-element__control">
                  <input type="text" name="applicant[If_Yes_How_Much_Stipend__c]"  value="{{isset($datas['Appli']['If_Yes_How_Much_Stipend__c'])?$datas['Appli']['If_Yes_How_Much_Stipend__c']:''}}" id="text-input-id-hpw" placeholder="Hours per week" required="" disabled="disabled"  class="gaccca-input" />
              ...
              <div class="gaccca-form-element gaccca-form-element-margin">
                ...
                <div class="gaccca-form-element__control">
                  <input type="text" name="applicant[Value_Of_Housing_In_USD_Per_Month__c]"  value="{{isset($datas['Appli']['Value_Of_Housing_In_USD_Per_Month__c'])?$datas['Appli']['Value_Of_Housing_In_USD_Per_Month__c']:''}}" id="text-input-id-vohiupm" placeholder="- Value of Housing in USD per month" required="" disabled="disabled"  class="gaccca-input" />
              ...
              <div class="gaccca-form-element gaccca-form-element-margin">
                ...
                <div class="gaccca-form-element__control">
                  <input type="text" name="applicant[Total_Flight_Expenses_In_USD__c]"  value="{{isset($datas['Appli']['Total_Flight_Expenses_In_USD__c'])?$datas['Appli']['Total_Flight_Expenses_In_USD__c']:''}}" id="text-input-id-tfeiu" placeholder="Total Flight Expenses in USD" required="" disabled="disabled"  class="gaccca-input" />
                  <span class="gaccca-input-help-text">If not applicable please fill in n/a</span>
                </div>
              ...
              <div class="gaccca-form-element gaccca-form-element-margin">
                ...
                <div class="gaccca-form-element__control">
                  <input type="text" name="applicant[Other_Compensation__c]"  value="{{isset($datas['Appli']['Other_Compensation__c'])?$datas['Appli']['Other_Compensation__c']:''}}" id="text-input-id-hpw" placeholder="- Other compensation" required="" disabled="disabled"  class="gaccca-input" />
            ...
            <div class="gaccca-form-element__control">
              ...
              <div class="gaccca-form-element__control">
                <label class="gaccca-form-element__label" for="text-input-id-fn">
                    ...
                    <span class="gaccca-radio">
                      <input type="radio" id="radio-purchase-no" disabled="disabled" value="no" name="expedited"  {{isset($datas['Appli']['Expedited__c']) &&  $datas['Appli']['Expedited__c']?'':'checked'}}/>
                      <label class="gaccca-radio__label" for="radio-purchase-no">
                        <span class="gaccca-radio_faux"></span>
                        <span class="gaccca-padding-right-25">No</span>
                      </label>
                      <input type="radio" id="radio-purchase-yes" disabled="disabled" value="yes" name="expedited" {{isset($datas['Appli']['Expedited__c']) &&  $datas['Appli']['Expedited__c']?'checked':''}}/>
        ...
        <div class="gaccca-form-element__control">
          ...
          <div class="gaccca-form-element__control">
            <label class="gaccca-form-element__label" for="text-input-id-fn">
                ...
                <span class="gaccca-radio">
                  <input type="radio" id="radio-spouse-no" disabled="disabled" value="no" name="j2VisaSpouse"  {{isset($datas['Appli']['J_2_Visa_Required__c']) &&  $datas['Appli']['J_2_Visa_Required__c']?'':'checked'}}/>
                  <label class="gaccca-radio__label" for="radio-spouse-no">
                    <span class="gaccca-radio_faux"></span>
                    <span class="gaccca-padding-right-25">No</span>
                  </label>
                  <input type="radio" id="radio-spouse-yes" disabled="disabled" value="yes" name="j2VisaSpouse" {{isset($datas['Appli']['J_2_Visa_Required__c']) &&  $datas['Appli']['J_2_Visa_Required__c']?'checked':''}}/>
          ...
          <div class="gaccca-form-element">
            ...
            <div class="gaccca-form-element__control">
              <input type="text" name='applicant[Number_of_j_2_visa__c]' value="{{isset($datas['Appli']['Number_of_j_2_visa__c'])?$datas['Appli']['Number_of_j_2_visa__c']:''}}" id="text-input-id-people" placeholder="" required="" disabled="disabled"  class="gaccca-input" />
            </div>
          </div>
          <br/>
          <div class="gaccca-form-element">
            ...
            <div class="gaccca-form-element__control">
              <div class="gaccca-select_container">
              <input type="text" name="applicant[How_did_you_hear_about_the_program__c]"  value="{{isset($datas['Appli']['How_did_you_hear_about_the_program__c'])?$datas['Appli']['How_did_you_hear_about_the_program__c']:''}}" id="text-input-id-hpw" placeholder="- Other compensation" required="" disabled="disabled"  class="gaccca-input" />
          ...
          <div class="gaccca-form-element__control">
            <label class="gaccca-form-element__label" for="text-input-id-fn">
                ...
                <span class="gaccca-radio">
                  <input type="radio" id="radio-j1applied-no" disabled="disabled" value="no" name="j1Sponsor"  {{isset($datas['j1Sponsor']) &&  $datas['j1Sponsor']?'':'checked'}} />
                  <label class="gaccca-radio__label" for="radio-j1applied-no">
                    <span class="gaccca-radio_faux"></span>
                    <span class="gaccca-padding-right-25">No</span>
                  </label>
                  <input type="radio" id="radio-j1applied-yes" disabled="disabled" value="yes" name="j1Sponsor"  {{isset($datas['j1Sponsor']) &&  $datas['j1Sponsor']?'checked':''}} />
