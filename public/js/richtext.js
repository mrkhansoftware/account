(function ( $ ) {
    ...
    $.fn.richText = function( options ) {
        ...
        var $editor,
            ...
            $btnFontColor = $('<a />', {class: "richText-btn", "title": settings.translations.addFontColor, html: '<span class="fa fa-paint-brush" style="color:#ed3bae"></span>'}), // font color
        ...
        // Help popup
        $editor.find(".richText-help").on("click", function() { return;
        ...
        $(document).on("input change blur keydown keyup", ".richText-editor", function(e) {// alert(1);
        ...
        $(document).on("input change blur", ".richText-initial", function() {// alert(3);
        ...
        $(document).on("dblclick mouseup", ".richText-editor", function() {// alert(4);
        ...
        // Resize images
        $(document).on('mousedown', function(e) { //alert(5);
            var $target = $(e.target);
        ...
        $(document)
            .mouseup(function(){ //alert(6);
                if($resizeImage) {
                    $resizeImage.css({'cursor' : 'default'});
                }
                $resizeImage = null;
            })
            .mousemove(function(e){ //alert(7);
                if($resizeImage!==null){
        ...
        $(document).on("click", ".richText-toolbar a[data-command]", function(event) {             var $button = $(this);
        ...
        function formatText(command, option, editorID) {
            ...
            if(command === "heading" && getSelectedText()) {
				...
				var contentValueSelected=getSelectedText(); //alert(contentValueSelected.length);
                if(contentValueSelected!='' && contentValueSelected.length!=0){
                    contentValueSelected=contentValueSelected.split('\n');
					contentValueSelected=contentValueSelected.join('<br>');
                }else{return;}
                
              if(option=='red'){
				 document.execCommand('insertHTML', true, "<span class='removeClass'>"+contentValueSelected+"</span>");
				}else if(option=='cyan'){
				document.execCommand('insertHTML', true, "<span class='suggestionClass'>"+contentValueSelected+"</span>");
				} 
				else if(option=='#FFFF00'){
					document.execCommand('insertHTML', true, "<span class='editClass'>"+contentValueSelected+"</span>");
				}else{
					document.execCommand('insertHTML', true, "<span class='undoClass'>"+contentValueSelected+"</span>");
				}
        ...
        */
        ...
        function getSelectedText() {
            ...
            if (window.getSelection) {  // all browsers, except IE before version 9
                ...
                return (range.toString()==null || range.toString()=='')?'':range.toString();
         ...
         * Save selection
         */
        function doSave(editorID) {//alert(editorID);
        ...
        function loadColors(command) {
            ...
            colors["cyan"] = settings.translations.cyan;
            ...
            for (var i in colors) {
				...
				var colorDesc='';
				if(i=='red'){
					colorDesc='Remove this';
				}else if(i=='cyan'){
					colorDesc='Suggestion';
				}else if(i=='#FFFF00'){
					colorDesc='Edit I made';
				}else{
					colorDesc='Clear';
				}
                result += '<li class="inline clearClassDel"><a data-command="' + command + '" data-option="' + i + '" style="text-align:left;" title="' + colors[i] + '"><span class="box-color" style="background-color:' + i + '"><span class="colorDesc">'+colorDesc+'</span></span></a></li>';
            }
            return result;
        }
